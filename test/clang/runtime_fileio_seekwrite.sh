#!/bin/sh
# Oracle-based runtime test: random-access write-back (ravn/z88dk#54).
# See runtime_fileio_seekwrite.c for the full description.
#
# GREEN (classic): sccz80 and llvmz80 both produce the four-record dump with
#   record 2 overwritten to 0x99 and records 0,1,3 intact.
...
SRC="$DIR/runtime_fileio_seekwrite.c"
...
if [ "$ACTUAL" = "$EXPECTED" ]; then
    ...
    echo "XFAIL: seek+write output differs from sccz80 oracle. got=[$ACTUAL] want=[$EXPECTED]"
fi
